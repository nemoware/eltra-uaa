package com.nemoware.eltra.uaa.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("EltraUAA");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("EltraUAA");
        ...
        config.getMapConfigs().put("com.nemoware.eltra.uaa.domain.*", initializeDomainMapConfig(jHipsterProperties));
