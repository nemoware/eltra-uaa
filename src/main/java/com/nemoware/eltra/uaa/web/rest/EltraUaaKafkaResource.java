...
@RestController
@RequestMapping("/api/eltra-uaa-kafka")
public class EltraUaaKafkaResource {

    private final Logger log = LoggerFactory.getLogger(EltraUaaKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public EltraUaaKafkaResource(KafkaProperties kafkaProperties) {
